...
public class EnemyFactory {
    ...
    public EnemyFactory(Context context, int tilesetResourceId, int tileWidth, int tileHeight) {
        this.spriteExtractor = new SpriteExtractor(context, tilesetResourceId, tileWidth, tileHeight);
    }

    public Enemy createEnemy(EnemyType enemyType) {
        Bitmap sprite = spriteExtractor.getSprite(enemyType.getTileID(), enemyType.getWidthInTiles(), enemyType.getHeightInTiles());
    ...
    public Bitmap getSprite(EnemyType enemyType) {
        return spriteExtractor.getSprite(enemyType.getTileID(), enemyType.getWidthInTiles(), enemyType.getHeightInTiles());
    }
}